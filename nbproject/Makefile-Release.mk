...
${OBJECTDIR}/src/LineFollower.o: src/LineFollower.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LineFollower.o src/LineFollower.cpp

${OBJECTDIR}/src/UART.o: src/UART.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UART.o src/UART.cpp

${OBJECTDIR}/src/acquisition.o: src/acquisition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/acquisition.o src/acquisition.cpp

${OBJECTDIR}/src/control.o: src/control.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/control.o src/control.cpp
